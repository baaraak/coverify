import { PureComponent, createElement, Children, Fragment, forwardRef } from 'react';
...
class Snuggle extends PureComponent {
    constructor(props) {
        super(props);
        this.gridId = null;
    ...
    render() {
        const _a = this.props, { children, item = createElement('div'), container = createElement('div'), innerRef } = _a, compProps = __rest(_a, ["children", "item", "container", "innerRef"]);
...
var index = forwardRef((props, ref) => (createElement(Snuggle, Object.assign({ innerRef: ref }, props))));
